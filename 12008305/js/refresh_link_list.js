...
refApp.controller('refCtrl', ['$scope', '$filter', function($scope, $filter) {
	...
	$scope.data = [{
		...
		idol: "あんざいみやこ_ふるさわよりこ_アンザイミヤコ_フルサワヨリコ_安斎都_古澤頼子_안자이미야코_후루사와요리코"
	}, /*{
		id: 21,
		name: ["豆まきパーティーへ", "ようこそ！"],
		idol: ""
		...
		idol: "しらぎくほたる_おかざきやすは_せきひろみ_まつおちづる_シラギクホタル_オカザキヤスハ_セキヒロミ_マツオチヅル_白菊ほたる_岡崎泰葉_関裕美_松尾千鶴_시라기쿠호타루_오카자키야스하_세키히로미_마츠오치즈루"
	}, {
		id: 25,
		name: ["수험에 얽힌", "에세트라♪"],
		...
		idol: "ひめかわゆき_ひのあかね_さわだまりな_ヒメカワユキ_ヒノアカネ_サワダマリナ_姫川由紀_日野茜_沢田麻理菜_히메카와유키_히노아카네_사와다마리나"
	}];
	$scope.q = '';
