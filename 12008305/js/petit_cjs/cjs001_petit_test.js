...
// stage content:
(lib.cjs001_petit_test = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// timeline functions:
	this.frame_0 = function() {
		this.cjs001_petit_test.stop();
	}
	...
	// base
	this.cjs001_petit_test = new lib.character_container();

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.cjs001_petit_test}]}).wait(14));
...
(lib.cheek_flush_small = function() {
	this.initialize();
...
(lib.cheek_flush_normal = function() {
	this.initialize();
...
(lib.question = function() {
	...
	// レイヤー 3
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FFFFFF","#FFDDB6"],[0.463,1],0,-17.6,0.3,17.7).s().p("Ag9CaIAAgQQgBglARgbQAQgaAhgYQAUgLAJgMQAJgKgBgRQAAgRgNgLQgNgKgVgBQgXAAgNARQgOAQABAgIh5gQQABgxAXgiQAXgiAogTQApgSAxAAQA0AAAoARQAnARAWAeQAWAdABAoQAAAogPAeQgQAdgjAXIgcATQgLAIgHALQgIAJAAAPIABAMIABALIh1ABIgDgRg");
	this.shape.setTransform(-0.2,-7.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFE1BF").s().p("AhBg7ICCgBIABB4IiCABg");
	...
	this.shape_2.setTransform(-0.1,0.2,1.161,1.161,-0.4);
	...
	this.shape_3.setTransform(-0.1,0.2,1.161,1.161,-0.4);

	this.addChild(this.shape_3,this.shape_2,this.shape_1,this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-17.9,-24.8,35.5,50.2);
...
(lib.hair_tail_left_small = function() {
	...
	this.replace_hair_tail_left.setTransform(-51.1,-53.6,0.5,0.5,0,0,0,1,-0.9);

	this.addChild(this.replace_hair_tail_left);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-51.7,-53.2,120,175);
...
(lib.item_back_upper_2 = function() {
	this.initialize();
...
(lib.item_back_lower_2 = function() {
	this.initialize();
...
(lib.hand_R_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.hand_L_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.hair_tail_right_2 = function() {
	this.initialize();
...
(lib.hair_tail_center_2 = function() {
	this.initialize();
...
(lib.face_expression = function(mode,startPosition,loop) {
	...
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("AkqEXIAAouIJVAAIAAIug");
	...
	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:0,y:7.9}).wait(16).to({graphics:mask_1_graphics_16,x:0,y:2.3}).wait(1).to({graphics:mask_1_graphics_17,x:0,y:1.5}).wait(1).to({graphics:mask_1_graphics_18,x:2,y:13.5}).wait(1).to({graphics:mask_1_graphics_19,x:2,y:13.5}).wait(1));
...
(lib.face_base_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.replace_cheek_flush = new lib.cheek_flush_normal();
	...
	this.replace_cheek_flush_small = new lib.cheek_flush_small();
...
(lib.character_motion_base = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{stay:8,in_walk:25,walk_loop:31,nod:59,nod_smile:76,happy:93,joy:119,light_joy:137,smile_left:155,smile_right:175,question_left:195,question_right:215,notice:235,shout:251,shock:275,amazement:299,angry:323,trouble:341,deny:354,shy:387,smug:407,panic:430,sit_down:444,stay_sit:459,nod_sit:481,nod_smile_sit:498,happy_sit:517,joy_sit:536,light_joy_sit:556,smile_left_sit:576,smile_right_sit:596,shout_sit:616,shock_sit:641,amazement_sit:669,angry_sit:689,trouble_sit:707,question_left_sit:720,question_right_sit:740,notice_sit:760,deny_sit:776,shy_sit:809,smug_sit:830,panic_sit:847,bye_sit:862,out:900,stay_small:917,in_walk_small:939,walk_loop_small:945,nod_small:970,nod_smile_small:978,happy_small:990,joy_small:999,light_joy_small:1006,smile_left_small:1016,smile_right_small:1027,question_left_small:1039,question_right_small:1052,notice_small:1066,shout_small:1075,shock_small:1084,amazement_small:1093,angry_small:1105,trouble_small:1114,deny_small:1124,shy_small:1132,smug_small:1140,sit_down_small:1148,stay_sit_small:1161,nod_sit_small:1174,nod_smile_sit_small:1184,happy_sit_small:1198,joy_sit_small:1210,light_joy_sit_small:1220,smile_left_sit_small:1233,smile_right_sit_small:1247,question_left_sit_small:1262,question_right_sit_small:1278,notice_sit_small:1295,shout_sit_small:1306,shock_sit_small:1317,amazement_sit_small:1328,angry_sit_small:1342,trouble_sit_small:1353,deny_sit_small:1365,shy_sit_small:1376,smug_sit_small:1386,bye_sit_small:1397,out_small:1407});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(8).call(this.frame_8).wait(16).call(this.frame_24).wait(27).call(this.frame_51).wait(24).call(this.frame_75).wait(17).call(this.frame_92).wait(26).call(this.frame_118).wait(18).call(this.frame_136).wait(18).call(this.frame_154).wait(20).call(this.frame_174).wait(20).call(this.frame_194).wait(20).call(this.frame_214).wait(20).call(this.frame_234).wait(16).call(this.frame_250).wait(24).call(this.frame_274).wait(24).call(this.frame_298).wait(24).call(this.frame_322).wait(18).call(this.frame_340).wait(13).call(this.frame_353).wait(33).call(this.frame_386).wait(20).call(this.frame_406).wait(23).call(this.frame_429).wait(14).call(this.frame_443).wait(14).call(this.frame_457).wait(23).call(this.frame_480).wait(17).call(this.frame_497).wait(19).call(this.frame_516).wait(19).call(this.frame_535).wait(20).call(this.frame_555).wait(20).call(this.frame_575).wait(20).call(this.frame_595).wait(20).call(this.frame_615).wait(25).call(this.frame_640).wait(28).call(this.frame_668).wait(20).call(this.frame_688).wait(18).call(this.frame_706).wait(13).call(this.frame_719).wait(20).call(this.frame_739).wait(20).call(this.frame_759).wait(16).call(this.frame_775).wait(33).call(this.frame_808).wait(21).call(this.frame_829).wait(17).call(this.frame_846).wait(15).call(this.frame_861).wait(34).call(this.frame_895).wait(7).call(this.frame_902).wait(15).call(this.frame_917).wait(16).call(this.frame_933).wait(6).call(this.frame_939).wait(26).call(this.frame_965).wait(12).call(this.frame_977).wait(12).call(this.frame_989).wait(9).call(this.frame_998).wait(7).call(this.frame_1005).wait(10).call(this.frame_1015).wait(11).call(this.frame_1026).wait(12).call(this.frame_1038).wait(13).call(this.frame_1051).wait(14).call(this.frame_1065).wait(9).call(this.frame_1074).wait(9).call(this.frame_1083).wait(9).call(this.frame_1092).wait(12).call(this.frame_1104).wait(9).call(this.frame_1113).wait(10).call(this.frame_1123).wait(8).call(this.frame_1131).wait(8).call(this.frame_1139).wait(8).call(this.frame_1147).wait(11).call(this.frame_1158).wait(15).call(this.frame_1173).wait(10).call(this.frame_1183).wait(14).call(this.frame_1197).wait(12).call(this.frame_1209).wait(10).call(this.frame_1219).wait(13).call(this.frame_1232).wait(14).call(this.frame_1246).wait(15).call(this.frame_1261).wait(16).call(this.frame_1277).wait(17).call(this.frame_1294).wait(11).call(this.frame_1305).wait(11).call(this.frame_1316).wait(11).call(this.frame_1327).wait(14).call(this.frame_1341).wait(11).call(this.frame_1352).wait(12).call(this.frame_1364).wait(11).call(this.frame_1375).wait(10).call(this.frame_1385).wait(11).call(this.frame_1396).wait(10).call(this.frame_1406).wait(4).call(this.frame_1410));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(430).to({_off:false},0).to({_off:true},13).wait(968));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(323).to({startPosition:0,_off:false},0).to({_off:true},17).wait(349).to({startPosition:0,_off:false},0).to({_off:true},13).wait(709));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(237).to({startPosition:0,_off:false},0).to({_off:true},13).wait(512).to({startPosition:0,_off:false},0).to({_off:true},13).wait(636));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(195).wait(1).to({_off:false},0).to({x:-44.9,y:-145,alpha:1},3,cjs.Ease.get(1)).to({x:-41.6,y:-138.9},4,cjs.Ease.get(-0.99)).to({x:-42.1,y:-139.7},2).wait(3).to({x:-39.3,y:-134.7,alpha:0},5,cjs.Ease.get(0.3)).to({_off:true},1).wait(1).to({rotation:28.4,x:33.4,y:-129.9,_off:false},0).to({x:42.1,y:-144.6,alpha:1},3,cjs.Ease.get(1)).to({x:38.7,y:-138.4},4,cjs.Ease.get(-0.99)).to({x:39.2,y:-139.3},2).wait(3).to({x:36.5,y:-134.1,alpha:0},5,cjs.Ease.get(0.3)).to({_off:true},1).wait(488).to({rotation:-28.3,x:-37.4,y:-129.8,_off:false},0).to({x:-44.9,y:-145,alpha:1},3,cjs.Ease.get(1)).to({x:-41.6,y:-138.9},4,cjs.Ease.get(-0.99)).to({x:-42.1,y:-139.7},2).wait(3).to({x:-39.3,y:-134.7,alpha:0},5,cjs.Ease.get(0.3)).to({_off:true},1).wait(1).to({rotation:28.4,x:33.4,y:-129.9,_off:false},0).to({x:42.1,y:-144.6,alpha:1},3,cjs.Ease.get(1)).to({x:38.7,y:-138.4},4,cjs.Ease.get(-0.99)).to({x:39.2,y:-139.3},2).wait(3).to({x:36.5,y:-134.1,alpha:0},5,cjs.Ease.get(0.3)).to({_off:true},1).wait(653));
	...
	this.timeline.addTween(cjs.Tween.get(this.body).wait(1).to({_off:false},0).wait(7).to({y:-56.3},8).to({y:-57.8},8).wait(1).to({x:-1.1,y:-53.8},6).to({x:-0.9,y:-57.8},5).to({x:-1.3,y:-53.8},5).to({x:-0.9,y:-57.8},5).to({x:-1.1,y:-53.8},5).wait(6).to({x:-1.3,y:-57.8},0).wait(2).to({rotation:-1.5,x:-2.1},7).to({rotation:0,x:-1.3},9).wait(1).to({rotation:-1.5,x:-2.1},7).to({rotation:0,x:-1.3},9).wait(1).to({scaleY:0.97,skewX:-0.5,skewY:-0.7,x:1.1,y:-54.2},3).to({scaleY:1,rotation:-10.4,skewX:0,skewY:0,x:-8,y:-68.9},5).to({rotation:0,skewX:-13.5,skewY:-13.6,x:-11.8,y:-57.3},4).to({rotation:-13.6,skewX:0,skewY:0,y:-58.8},3).wait(3).to({rotation:0,x:-1.3,y:-57.8},5).wait(3).to({rotation:-4.9,x:-3.7,y:-54.8},4).to({rotation:5.5,x:-2.8,y:-57.5},5).wait(3).to({rotation:0,x:-1.3,y:-57.8},5).wait(1).to({rotation:-4.9,x:-3.7,y:-54.8},4).to({rotation:5.5,x:-2.8,y:-57.5},5).wait(3).to({rotation:0,x:-1.3,y:-57.8},5).wait(1).to({rotation:-1.5,x:-2.1},7).wait(4).to({rotation:0,x:-1.3},8).wait(1).to({rotation:3.5,x:0.4},7).wait(4).to({rotation:0,x:-1.3},8).wait(1).to({rotation:-1.5,x:-2.1},7).wait(4).to({rotation:0,x:-1.3},8).wait(1).to({rotation:3.5,x:0.4},7).wait(4).to({rotation:0,x:-1.3},8).wait(1).to({rotation:2.7,x:0,y:-58.2},2,cjs.Ease.get(-0.99)).to({rotation:1.8,x:-0.4,y:-58.1},3,cjs.Ease.get(1)).wait(7).to({rotation:0,x:-1.3,y:-57.8},3).wait(1).to({rotation:-2.3,x:-2.6,y:-52.1},4).to({rotation:-5.2,x:-4.3,y:-59.9},5).to({x:-3.9,y:-58.7},4,cjs.Ease.get(1)).wait(6).to({rotation:0,x:-1.3,y:-57.8},4).wait(1).to({rotation:10.2,x:7.1,y:-65.4},5).to({rotation:11.4,x:8.4,y:-59.4},4).to({rotation:10.2,x:7.1},4).wait(5).to({rotation:0,x:-1.3,y:-57.8},5).wait(25).to({y:-55.3},2).to({y:-62.6},2,cjs.Ease.get(-0.99)).to({y:-56.8},2,cjs.Ease.get(1)).to({y:-62.6},2,cjs.Ease.get(-0.99)).to({y:-57.8},2,cjs.Ease.get(1)).wait(8).to({rotation:-2,x:-2.4,y:-56.5},6).to({rotation:0,x:-1.3,y:-57.8},6).wait(1).to({rotation:-4.4,x:-4.5,y:-54.9},4).to({rotation:0.5,x:-1.4,y:-58},3).to({rotation:2,x:-0.8,y:-57.6},1).to({rotation:3.7,x:1.1,y:-58.4},4).to({rotation:-0.3,x:-2.7,y:-57.9},4).to({rotation:-0.3,x:0,y:-58.2},4).to({rotation:2.8,y:-58},3).to({rotation:3.7,x:0.5,y:-58.2},4).to({rotation:0,x:-1.3,y:-57.8},5).wait(1).to({rotation:-2.7,x:-2.1,y:-57.4},4).to({rotation:-1.8,x:-1.6,y:-57.6},4,cjs.Ease.get(1)).wait(7).to({rotation:0,x:-1.3,y:-57.8},4).wait(1).to({rotation:-5.7,x:-4.7,y:-58.8},4).to({rotation:3.4,x:0.1,y:-56.3},4).to({rotation:2.2,x:-0.3,y:-57.4},3).wait(7).to({rotation:0,x:-1.3,y:-57.8},4).wait(1).to({rotation:2.5,x:1,y:-58.2},0).wait(1).to({rotation:3.5,x:1.9,y:-58.3},0).wait(7).to({rotation:0,x:-1.3,y:-57.8},5).wait(1).to({rotation:-1.2,x:-2.8,y:-56.4},3,cjs.Ease.get(1)).to({rotation:0,x:-1.3,y:-60.9},4).to({rotation:1,x:-0.9,y:-57.2},4).to({rotation:0,x:-1.3,y:-57.8},2).wait(2).to({rotation:-1,x:-1.8,y:-57.5},10).to({rotation:0,x:-1.3,y:-57.8},11).wait(1).to({rotation:-1.5,x:-2.1},7).to({rotation:0,x:-1.3},9).wait(1).to({rotation:-1.5,x:-2.1},9).to({rotation:0,x:-1.3},9).wait(20).to({rotation:-3.4,x:-2.5,y:-57.5},5).to({rotation:5.5,x:0.5,y:-58.3},4).to({rotation:5.1,x:0.4,y:-58.4},5).to({rotation:0,x:-1.3,y:-57.8},5).wait(1).to({rotation:-3.4,x:-2.5,y:-57.5},5).to({rotation:5.5,x:0.5,y:-58.3},4).to({rotation:5.1,x:0.4,y:-58.4},5).to({rotation:0,x:-1.3,y:-57.8},5).wait(1).to({rotation:-1.5,x:-2.1},7).wait(4).to({rotation:0,x:-1.3},8).wait(1).to({rotation:3.5,x:0.4},7).wait(4).to({rotation:0,x:-1.3},8).wait(1).to({rotation:-2.5,x:-2.6,y:-57.9},4).to({rotation:5.6,x:1,y:-57.7},5,cjs.Ease.get(-0.99)).to({rotation:4.7,x:0.6},3).wait(7).to({rotation:0,x:-1.3,y:-57.8},5).wait(1).to({rotation:3,x:0,y:-58.8},3).to({rotation:5.7,x:1.1,y:-57.1},3).to({rotation:4.9,x:0.8,y:-57.5},3).wait(13).to({rotation:0,x:-1.3,y:-57.8},5).wait(21).to({y:-57.2},3).to({y:-57.8},3).to({y:-57},3).to({y:-57.8},4).wait(5).to({rotation:-2,x:-2.4,y:-56.5},6).to({rotation:0,x:-1.3,y:-57.8},6).wait(1).to({rotation:-1.5,x:-2.1},7).wait(4).to({rotation:0,x:-1.3},8).wait(1).to({rotation:3.5,x:0.4},7).wait(4).to({rotation:0,x:-1.3},8).wait(1).to({rotation:2.7,x:0,y:-58.2},2,cjs.Ease.get(-0.99)).to({rotation:1.8,x:-0.4,y:-58.1},3,cjs.Ease.get(1)).wait(7).to({rotation:0,x:-1.3,y:-57.8},3).wait(1).to({rotation:-4.4,x:-3.9,y:-57.1},4).to({rotation:0.5,x:-1.4,y:-58},3).to({rotation:2,x:-0.8,y:-57.6},1).to({rotation:3.7,x:0.1,y:-58.4},4).to({rotation:-0.3,x:-2.1,y:-57.9},4).to({rotation:-0.3,x:-0.8,y:-58.2},4).to({rotation:2.8,x:0,y:-58},3).to({rotation:3.7,x:0.5,y:-58.2},4).to({rotation:0,x:-1.3,y:-57.8},5).wait(1).to({rotation:-2.7,x:-2.1,y:-57.4},4).to({rotation:-1.8,x:-1.6,y:-57.6},4,cjs.Ease.get(1)).wait(7).to({rotation:0,x:-1.3,y:-57.8},4).wait(34).to({rotation:-3.2,x:-2.9,y:-57.7},4).to({rotation:1.5,x:-0.6},3).to({rotation:-0.8,x:-1.8,y:-57.9},4).to({rotation:0.2,x:-1.2},4).wait(14).to({rotation:0.2},0).to({rotation:0,x:-1.3,y:-57.8},4).to({_off:true},5).wait(10).to({_off:false},0).wait(7).to({y:-56.5},8).to({y:-57.8},8).wait(1).wait(5).to({x:-1.4},0).to({y:-53.8},6).to({x:-1.3,y:-57.8},5).to({y:-53.8},5).to({y:-57.8},5).to({x:-1.4,y:-53.8},5).wait(3).to({x:-1.3,y:-57.8},0).to({_off:true},439).wait(4));

	// hand_R
	this.instance_14 = new lib.hand_R_1("single",1);
	this.instance_14.setTransform(-17.5,-47.3);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(1).to({startPosition:1,_off:false},0).wait(7).to({startPosition:1},0).to({rotation:5.6,x:-18.8,y:-46.1},8).to({rotation:0,x:-17.4,y:-47.2},8).wait(1).to({startPosition:1},0).to({rotation:-13.8,x:-4.1,y:-44.5},6).to({rotation:4.6,x:-12.2,y:-48.6},5).to({rotation:23.5,x:-21.1,y:-44.8},5).to({rotation:4.6,x:-12.2,y:-48.6},5).to({rotation:-13.8,x:-4.1,y:-44.5},5).wait(6).to({rotation:0,x:-17.4,y:-47.2},0).wait(2).to({startPosition:1},0).to({rotation:-1.5,x:-17.9,y:-46.7},7).to({rotation:0,x:-17.4,y:-47.2},9).wait(1).to({startPosition:1},0).to({rotation:20.2,x:-24,y:-49.6},7).to({rotation:0,x:-17.4,y:-47.2},9).wait(1).to({mode:"independent"},0).to({scaleX:0.99,scaleY:0.98,skewX:130.6,skewY:132.3,x:-14.7,y:-43.6},3).to({skewX:125.1,skewY:126.8,x:-20.9,y:-47.5},2).to({_off:true},1).wait(17).to({scaleX:1,scaleY:1,skewX:0,skewY:0,x:-17.4,y:-47.2,mode:"single",startPosition:1,_off:false},0).wait(3).to({startPosition:1},0).to({rotation:91.6,x:-16.2,y:-42.9},4).to({rotation:63.9,x:-28.8,y:-59.9},5).to({startPosition:1},3).to({rotation:0,x:-17.4,y:-47.2},5).wait(1).to({startPosition:1},0).to({rotation:91.6,x:-16.2,y:-42.9},4).to({rotation:63.9,x:-28.8,y:-59.9},5).to({startPosition:1},3).to({rotation:0,x:-17.4,y:-47.2},5).wait(1).to({startPosition:1},0).to({rotation:-1.5,x:-17.9,y:-46.7},7).wait(4).to({startPosition:1},0).to({rotation:0,x:-17.4,y:-47.2},8).wait(1).to({startPosition:1},0).to({rotation:3.5,x:-16.2,y:-48.2},7).wait(4).to({startPosition:1},0).to({rotation:0,x:-17.4,y:-47.2},8).wait(1).to({startPosition:1},0).to({rotation:-1.5,x:-17.9,y:-46.7},7).wait(4).to({startPosition:1},0).to({rotation:0,x:-17.4,y:-47.2},8).wait(1).to({startPosition:1},0).to({rotation:3.5,x:-16.2,y:-48.2},7).wait(4).to({startPosition:1},0).to({rotation:0,x:-17.4,y:-47.2},8).wait(1).to({startPosition:1},0).to({rotation:15.6,x:-20,y:-50.2},2,cjs.Ease.get(-0.99)).to({rotation:13.4,y:-49.5},3,cjs.Ease.get(1)).wait(7).to({startPosition:1},0).to({rotation:0,x:-17.4,y:-47.2},3).wait(1).to({startPosition:1},0).to({rotation:84.7,x:-25.9,y:-45.3},4).to({rotation:87.2,x:-28.6,y:-48.8},2).to({rotation:93.8,x:-31.6,y:-58.1},2).to({rotation:104.8,x:-31.1,y:-74.2},1).to({x:-29.5,y:-72.2},4,cjs.Ease.get(1)).wait(6).to({startPosition:1},0).to({scaleX:1,scaleY:1,rotation:90.7,x:-29.9,y:-69.9},1).to({rotation:65.4,x:-30.4,y:-60.7},1).to({rotation:17.8,x:-22.1,y:-50.1},1).to({scaleX:1,scaleY:1,rotation:0,x:-17.4,y:-47.2},1).wait(1).to({startPosition:1},0).to({rotation:5.8,x:-18.1,y:-48.7},1).to({scaleX:1,scaleY:1,rotation:27.1,x:-21.1,y:-53.5},1).to({rotation:65.4,x:-23.6,y:-65.6},1).to({rotation:100.3,x:-18.7,y:-78.2},1).to({scaleX:1,scaleY:1,rotation:112,x:-16.1,y:-81.8},1).to({rotation:113.2,x:-14.4,y:-76.3},4).to({rotation:112,x:-16.1,y:-75.8},4).wait(5).to({startPosition:1},0).to({scaleX:1,scaleY:1,rotation:106.1,x:-17.9,y:-74.8},1).to({scaleX:1,scaleY:1,rotation:85,x:-21.4,y:-68.4},1).to({scaleX:1,scaleY:1,rotation:46.9,x:-23.1,y:-56.9},1).to({scaleX:1,scaleY:1,rotation:11.6,x:-19.3,y:-49.2},1).to({scaleX:1,scaleY:1,rotation:0,x:-17.4,y:-47.2},1).wait(1).to({startPosition:1},0).wait(23).to({startPosition:1},0).wait(1).to({rotation:120.3,x:-24.4,y:-74.2},0).to({y:-71.7},2).to({y:-78.9},2,cjs.Ease.get(-0.99)).to({y:-73.2},2,cjs.Ease.get(1)).to({y:-78.9},2,cjs.Ease.get(-0.99)).to({y:-74.2},2,cjs.Ease.get(1)).to({startPosition:1},2).to({scaleX:1,scaleY:1,rotation:110,x:-26.5,y:-72.4},1).to({rotation:72.5,x:-29.3,y:-62.4},1).to({rotation:19.8,x:-22.3,y:-49.6},1).to({scaleX:1,scaleY:1,rotation:0,x:-17.4,y:-47.2},1).wait(2).to({startPosition:1},0).to({rotation:1.2,x:-18.1,y:-45.2},6).to({rotation:0,x:-17.4,y:-47.2},6).wait(1).to({startPosition:1},0).to({rotation:2.4,x:-20.2,y:-44.6},4).to({rotation:46.5,x:-24.8,y:-53.8},3).to({_off:true},1).wait(20).to({rotation:0,skewX:146,skewY:-33.8,x:-23.1,y:-53.5,_off:false},0).to({scaleX:1,scaleY:1,skewX:124.1,skewY:-55.7,x:-20.8,y:-50.2},2).to({skewX:50.1,skewY:-129.7,x:-19.3,y:-48.2},1).to({scaleX:1,scaleY:1,skewX:0,skewY:0,x:-17.4,y:-47.2},1).to({_off:true},1).wait(19).wait(1).to({startPosition:1,_off:false},0).to({rotation:9.8,x:-24.2,y:-48.3},4,cjs.Ease.get(1)).to({rotation:3.4,x:-16.4,y:-46.7},4).to({rotation:2.2,x:-16.8,y:-47.4},3).wait(7).to({startPosition:1},0).to({rotation:0,x:-17.4,y:-47.2},4).wait(1).to({rotation:13.5,x:-18.3,y:-49.6},0).wait(1).to({rotation:67.1,x:-25.1,y:-63.2},0).wait(1).to({rotation:22.2,x:-19.3,y:-51.8},0).wait(1).to({rotation:62.1,x:-25,y:-61.8},0).wait(1).to({rotation:22.2,x:-19.3,y:-51.8},0).wait(1).to({rotation:71.6,x:-25.3,y:-64.6},0).wait(3).to({startPosition:1},0).to({rotation:0,x:-17.4,y:-47.2},5).wait(1).to({startPosition:1},0).to({rotation:5.5,x:-20.5,y:-46},3,cjs.Ease.get(1)).to({rotation:-7,x:-15.3,y:-49.7},4).to({rotation:1,x:-17.1,y:-46.8},4).to({rotation:0,x:-17.4,y:-47.2},2).wait(2).to({startPosition:1},0).to({rotation:-1,x:-17.9,y:-46.6},10).to({rotation:0,x:-17.4,y:-47.2},11).wait(1).to({startPosition:1},0).to({rotation:0.5,x:-17.6},7).to({rotation:0,x:-17.4},9).wait(1).to({startPosition:1},0).to({rotation:0.5,x:-17.6},9).to({rotation:0,x:-17.4},9).wait(20).to({startPosition:1},0).to({rotation:93.1,x:-15.4,y:-46},5).to({rotation:63.9,x:-25.4,y:-60.7},4).to({rotation:61.7,y:-60.1},5).to({rotation:0,x:-17.4,y:-47.2},5).wait(1).to({startPosition:1},0).to({rotation:93.1,x:-15.4,y:-46},5).to({rotation:63.9,x:-25.4,y:-60.7},4).to({rotation:61.7,y:-60.1},5).to({rotation:0,x:-17.4,y:-47.2},5).wait(1).to({startPosition:1},0).to({rotation:-1.5,x:-17.9,y:-46.7},7).wait(4).to({startPosition:1},0).to({rotation:0,x:-17.4,y:-47.2},8).wait(1).to({startPosition:1},0).to({rotation:3.5,x:-16.2,y:-48.2},7).wait(4).to({startPosition:1},0).to({rotation:0,x:-17.4,y:-47.2},8).wait(1).to({startPosition:1},0).to({rotation:118.3,x:-20.5,y:-48.1},4).to({rotation:114.7,x:-21.4,y:-75.8},5,cjs.Ease.get(-0.99)).to({rotation:113.7,x:-22.1,y:-75.5},3).wait(7).to({startPosition:1},0).to({rotation:0,x:-17.4,y:-47.2},5).wait(1).to({startPosition:1},0).to({scaleX:1,scaleY:1,rotation:76.7,x:-27.3,y:-66.4},3).to({scaleX:1,scaleY:1,rotation:123.1,x:-20,y:-76.9},3).to({rotation:111.1,x:-23,y:-74.6},3).wait(13).to({rotation:116.4,x:-21.9,y:-75.8},0).to({rotation:0,x:-17.4,y:-47.2},5).wait(1).to({startPosition:1},0).wait(19).to({startPosition:1},0).wait(1).to({rotation:107.5,x:-25.8,y:-73.2},0).to({rotation:102.8,x:-26.6,y:-71.5},3).to({rotation:111.5,x:-25.1,y:-74.1},3).to({rotation:102.3,x:-26.7,y:-71},3).to({rotation:107.5,x:-25.8,y:-73.2},4).to({rotation:0,x:-17.4,y:-47.2},4).wait(1).to({startPosition:1},0).to({rotation:1.2,x:-18.1,y:-45.2},6).to({rotation:0,x:-17.4,y:-47.2},6).wait(1).to({startPosition:1},0).to({rotation:-1.5,x:-17.9,y:-46.7},7).wait(4).to({startPosition:1},0).to({rotation:0,x:-17.4,y:-47.2},8).wait(1).to({startPosition:1},0).to({rotation:3.5,x:-16.2,y:-48.2},7).wait(4).to({startPosition:1},0).to({rotation:0,x:-17.4,y:-47.2},8).wait(1).to({startPosition:1},0).to({rotation:15.6,x:-20,y:-50.2},2,cjs.Ease.get(-0.99)).to({rotation:11.7,x:-19.6,y:-49.3},3,cjs.Ease.get(1)).wait(7).to({startPosition:1},0).to({rotation:0,x:-17.4,y:-47.2},3).wait(1).to({startPosition:1},0).to({rotation:2.4,x:-19.6,y:-46.8},4).to({rotation:46.5,x:-24.8,y:-53.8},3).to({_off:true},1).wait(20).to({rotation:0,skewX:146,skewY:-33.8,x:-23.1,y:-53.9,_off:false},0).to({scaleX:1,scaleY:1,skewX:105.7,skewY:-74.1,x:-20.9,y:-50},2).to({skewX:50.1,skewY:-129.7,x:-19.3,y:-48.2},1).to({scaleX:1,scaleY:1,skewX:0,skewY:0,x:-17.4,y:-47.2},1).to({_off:true},1).wait(19).wait(2).to({startPosition:1,_off:false},0).wait(17).to({startPosition:1},0).wait(15).to({startPosition:1},0).to({scaleX:1,scaleY:1,rotation:90,x:-24.1,y:-48.9},4).to({_off:true},1).wait(24).wait(4).to({scaleX:1,scaleY:1,rotation:0,x:-17.4,y:-47.2,_off:false},0).to({_off:true},5).wait(10).to({x:-13.8,y:-41.2,_off:false},0).wait(7).to({startPosition:1},0).to({rotation:5.6,x:-15.2,y:-40.3},8).to({rotation:0,x:-13.8,y:-41.2},8).wait(1).to({startPosition:1},0).wait(5).to({x:-13.9},0).to({rotation:-13.8,x:-3.6,y:-38},6).to({rotation:4.6,x:-10.1,y:-41},5).to({rotation:23.5,x:-16.9,y:-38.8},5).to({rotation:4.6,x:-10.1,y:-41},5).to({rotation:-13.8,x:-3.6,y:-38},5).wait(3).to({rotation:0,x:-13.8,y:-41.2},0).to({_off:true},439).wait(4));
...
(lib.character_container_core = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{stay2:3,num1:9,num2:36,num3:70,num4:108,num5:147,"stay":195,"sit_down":200});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(8).call(this.frame_8).wait(27).call(this.frame_35).wait(34).call(this.frame_69).wait(38).call(this.frame_107).wait(39).call(this.frame_146).wait(48).call(this.frame_194).wait(5).call(this.frame_199).wait(11).call(this.frame_210).wait(4));

	// c
	this.c = new lib.character_motion_base();

	this.timeline.addTween(cjs.Tween.get(this.c).wait(3).wait(6).to({x:119.6,y:3.4},0).to({x:-6.2},26).wait(1).to({x:205},0).to({x:-6.2},33).wait(1).to({x:242.4},0).to({x:-6.2},37).wait(1).to({x:278.6},0).to({x:-6.2},38).wait(1).to({x:317.6},0).to({x:-6.2},47).wait(9).to({x:0,y:0},7).wait(5));
