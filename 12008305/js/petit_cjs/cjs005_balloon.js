...
(lib.fkds_inner2 = function(mode,startPosition,loop) {
	...
	// cursor9
	this.cursor9 = new lib.marker2();
	this.cursor9.setTransform(964,78.4,1,1,0,0,0,0,0.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.cursor9}]}).wait(3));
...
(lib.mc_fkds_set = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{start:1,stay:7});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(6).call(this.frame_6).wait(4).call(this.frame_10).wait(5));

	// core
	this.core = new lib.fkds_inner2();

	this.timeline.addTween(cjs.Tween.get(this.core).wait(1).to({scaleX:0.5,scaleY:0.2,y:56},0).to({scaleX:1.02,scaleY:1.02,y:-1.8},3,cjs.Ease.get(-0.99)).to({scaleX:1,scaleY:1,y:0},2).wait(10));
	...
	this.frame_0 = function() {
		...
		this.type_change = function(){
			...
			if(this.param.mode == 1){
				...
				this.mc.core.cursor3.gotoAndStop((0 + this.speak_type_num));
				this.mc.core.cursor9.gotoAndStop((4 + this.speak_type_num));
